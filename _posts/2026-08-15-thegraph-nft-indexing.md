...
{% comment %} TODO: 선미야클럽 subgraph의 실제 초기 동기화 소요 시간을 채워주세요 {% endcomment %}
...
{% comment %} TODO: 실제 프로젝트에서 스키마를 변경한 횟수와 그때의 재인덱싱 소요 시간을 채워주세요 {% endcomment %}
...
{% comment %} TODO: 실제로 운영하며 설정한 인덱싱 지연 임계치와 알림 구성을 채워주세요 {% endcomment %}
